...
mod tests {
    ...
    use crate::{repositories::{customer::{CustomerRepository}}, post_customer, get_views, patch_customer, delete_customer, get_customer};
    use super::{PostCustomerRequest, PatchCustomerRequest};
    ...
    async fn test_post_customer() {
        ...
        let req = test::TestRequest::post()
            ...
            .set_json(&PostCustomerRequest {
                ...
                about: "I am a test customer".to_string(),
