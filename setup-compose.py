...
def get_services(config, api_prefix, proxy_network, expose, open_database):
    ...
    return [
        ...
        Service(config, "users", PortConfig(expose, "3001"), APIConfig(api_prefix, ["user", "auth", "my_user", "waiting_list", "github", "organization", "my_organizations"]), **default_service_settings),
